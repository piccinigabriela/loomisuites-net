...
export const ChannelIntegrations: React.FC = () => {
  const channels = [
    ...
    {
      name: 'Booking.com',
      category: 'Partner Conectividad',
      badge: 'iCal + API Directa',
      color: 'border-blue-200 bg-blue-50/60 text-blue-800',
      icon: '🏨',
      desc: 'Evita dobles reservas bloqueando automáticamente fechas tan pronto entra un huésped.',
    },
    {
      name: 'VRBO / Expedia',
      ...
      icon: '✈️',
      desc: 'Accede al público de Estados Unidos y Europa con disponibilidad actualizada al instante.',
    },
    {
    ...
    },
    {
      ...
      category: 'Auto Check-in',
      badge: 'Tuya, Yale, Nuki, August',
      color: 'border-amber-200 bg-amber-50/60 text-amber-800',
      icon: '🔑',
      desc: 'Genera códigos PIN únicos que caducan exactamente al momento del check-out del huésped.',
    },
    {
      name: 'Cobros Directos',
      category: 'Pasarelas de Pago',
      badge: 'Stripe & MercadoPago',
      color: 'border-purple-200 bg-purple-50/60 text-purple-800',
      icon: '💳',
      desc: 'Cobra reservas directas en moneda local o dólares con seña y garantía contra daños.',
    },
  ];
