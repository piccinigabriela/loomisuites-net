        ...
        <div className="mt-14 bg-zinc-800/40 rounded-2xl p-6 sm:p-8 border border-zinc-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-emerald-950/20 border border-emerald-900/40 p-5 rounded-xl">
              <span className="text-xs font-bold text-emerald-400 uppercase tracking-wider block mb-2">
                ✅ Modelo Loomi Suite (Estilo BananaDesk)
              </span>
              <ul className="space-y-2.5 text-xs text-zinc-300">
                <li className="flex items-start gap-2">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-emerald-400 shrink-0 font-bold">•</span>
                  <span><strong>Acompañamiento por WhatsApp:</strong> Si prefieres ayuda, te guiamos en vivo compartiendo pantalla o por chat.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-emerald-400 shrink-0 font-bold">•</span>
                  <span><strong>Sin permanencia ni letras chicas:</strong> No pagas comisión sobre tus reservas y cancelas cuando quieras.</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-8 text-center">
            <button
              ...
              className="inline-flex items-center gap-2 text-xs font-semibold text-zinc-300 hover:text-white bg-zinc-800 hover:bg-zinc-700 px-5 py-2.5 rounded-xl border border-zinc-700 transition-colors cursor-pointer"
            >
              <MessageSquare className="w-3.5 h-3.5 text-rose-400" />
              <span>¿Tienes dudas sobre cómo migrar tu alojamiento? Habla con nosotros por WhatsApp</span>
            </button>
          </div>
        </div>
      </div>
