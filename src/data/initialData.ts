...
export function generateInitialReservations(): Reservation[] {
  return [
    ...
    },
    {
      ...
      paymentStatus: 'paid',
      pinCode: '7732#',
      specialNotes: 'Visita a Cataratas en pareja.',
  ...
  return [
    {
      ...
      notes: 'Huésped nuevo entra mañana. Dejar cesto de frutas de bienvenida.',
      photosUploaded: 2,
    },
    {
      id: 'clean-2',
      ...
      notes: 'El huésped que sale hace checkout a las 11:00 en punto.',
    },
    {
      id: 'clean-3',
      propertyId: 'prop-2',
